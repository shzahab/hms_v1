      ...
      <table className="min-w-full divide-y divide-gray-200">
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          <tr>
            ...
            <td className="px-6 py-4 text-sm text-gray-600">Handy Type (Direct-On-Line Start)</td>
          </tr>
          <tr className="bg-gray-50">
            <td className="px-6 py-4 text-sm font-medium text-gray-900">Drum Capacity</td>
            <td className="px-6 py-4 text-sm text-gray-600">280 Liters</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td className="px-6 py-4 text-sm text-gray-600">~180-200 Liters per batch</td>
          </tr>
          <tr className="bg-gray-50">
          ...
          <tr className="bg-green-50">
            ...
            <td className="px-6 py-4 text-sm font-bold text-green-700">₹26,000 + GST (18%)</td>
          </tr>
        </tbody>
      </table>
      
      <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
        <h4 className="font-semibold text-yellow-800 mb-2">💡 Handy Type Motor Advantage</h4>
        <p className="text-sm text-yellow-700">
          Handy type motors use direct-on-line (DOL) starting - a simpler, more robust design ideal for sites with stable power supply. 
          Fewer components mean less maintenance and longer service life compared to complex starting mechanisms.
        </p>
      </div>
