      ...
      <table className="min-w-full divide-y divide-gray-200">
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          <tr>
            ...
            <td className="px-6 py-4 text-sm text-gray-600">GF25-3PH</td>
          </tr>
          ...
          <tr className="bg-gray-50">
            ...
            <td className="px-6 py-4 text-sm text-gray-600">25-30 bends/minute</td>
          </tr>
          <tr>
            <td className="px-6 py-4 text-sm font-medium text-gray-900">Machine Weight</td>
            <td className="px-6 py-4 text-sm text-gray-600">~105 kg</td>
          </tr>
          <tr className="bg-gray-50">
            <td className="px-6 py-4 text-sm font-medium text-gray-900">Dimensions (L×W×H)</td>
            <td className="px-6 py-4 text-sm text-gray-600">750mm × 520mm × 780mm</td>
          </tr>
          <tr>
          ...
          <tr className="bg-green-50">
            ...
            <td className="px-6 py-4 text-sm font-bold text-green-700">₹38,000 + GST (18%)</td>
          </tr>
        </tbody>
      </table>
      
      <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
        <h4 className="font-semibold text-green-800 mb-2">⭐ Best Value Professional Machine</h4>
        <p className="text-sm text-green-700">
          The GF25 Three Phase offers the best balance of capacity (20mm), power (3kW), and price (₹38,000) 
          for professional contractors. Industrial duty cycle ensures reliable operation for high-volume work.
        </p>
      </div>
