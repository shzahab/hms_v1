      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
              Greaves 10HP Double Drum Roller
            </th>
          </tr>
        </thead>
        <tbody className="bg-white divide-y divide-gray-200">
          <tr>
            ...
            <td className="px-6 py-4 text-sm text-gray-600">Greaves</td>
          </tr>
          ...
          <tr className="bg-green-50">
            ...
            <td className="px-6 py-4 text-sm font-bold text-green-700">₹1,90,000 + GST (18%)</td>
          </tr>
        </tbody>
      </table>
      
      <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
        <h4 className="font-semibold text-yellow-800 mb-2">💡 Greaves Engine Advantage</h4>
        <p className="text-sm text-yellow-700">
          Greaves engines come with widespread service support across South India. You&apos;ll find authorized Greaves service centers in virtually every district, 
          ensuring quick access to spare parts and technical support. This makes it the preferred choice for contractors who need reliable after-sales service.
        </p>
      </div>
