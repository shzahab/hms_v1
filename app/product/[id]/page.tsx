...
export function generateMetadata({ params }: { params: { id: string } }): Metadata {
  ...
  if (!product) {
    return {
      title: "Product Not Found | Hutaib Machinery and Spares",
      description: "The requested product could not be found."
    };
  }

  return {
    title: `${product.name} | Hutaib Machinery and Spares`,
    description: product.shortDescription,
    keywords: `${product.name.toLowerCase()}, ${product.category.toLowerCase()}, industrial machinery, spare parts`,
    openGraph: {
      title: `${product.name} | Hutaib Machinery and Spares`,
      description: product.shortDescription,
      images: [
